...
//        dut.io.weight.poke(Float2SInt(weights(idx), dataWidth, binaryPoint).S)
//        dut.io.inputAct.poke(Float2SInt(inputActivations(idx), dataWidth, binaryPoint).S)
//        if(arthimetic == 0){ // MUL
...
//          s"${SInt2Float(dut.io.result.peek().litValue().toInt, binaryPoint)} " +
